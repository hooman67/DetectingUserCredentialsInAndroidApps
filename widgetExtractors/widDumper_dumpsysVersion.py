...
###################communication start#############################################
    ...
    ff=open("hsSYSDUMP_"+currentPackageName+".txt", "w")
    ...
    try:              
        ...
        result2=subprocess.Popen(command_dump, shell=False, stdout=subprocess.PIPE)
        result2=result2.stdout.read()
        time.sleep(10)
        ff.write(str(result2))
        print("systemDump created moving on to AFTF\n")
        #print(str(result2));
